...
C     
C     Generated by MadGraph5_aMC@NLO v. 3.3.2, 2022-03-18
...
C     
C     Process: e+ e- > w+ w- WEIGHTED<=4 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1)) ! count 3
      CALL OXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2)) ! count 2
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,3)) ! count 2
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,4)) ! count 3
      CALL IXXXXX(P(0,3),ZERO,+1,-1*IC(3),W(1,5)) ! count 1
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,6)) ! count 1
      CALL FFV2_3(W(1,5),W(1,6),GC_100,MDL_MW, FK_MDL_WW,W(1,7)) ! count 5
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8)) ! count 1
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,9)) ! count 1
      CALL FFV2_3(W(1,9),W(1,8),GC_100,MDL_MW, FK_MDL_WW,W(1,10)) ! count 5
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO, FK_ZERO,W(1,11)) ! count 1
      CALL FFV1P0_3(W(1,4),W(1,1),GC_3,ZERO, FK_ZERO,W(1,12)) ! count 1
      CALL VVV1P1N_1(W(1,10), W(1,7), -GC_3, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/11,12/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV2_4_3(W(1,3),W(1,2),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,13)) ! count 1
      CALL FFV2_4_3(W(1,4),W(1,1),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,14)) ! count 1
      CALL VVV1P1N_3(W(1,10), W(1,7), GC_53, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/13,14/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV2_1(W(1,1),W(1,7),GC_100,ZERO, FK_ZERO,W(1,15)) ! count 1
      CALL FFV2_0(W(1,4),W(1,15),W(1,10),GC_100,AMP(2,3)) ! count 1
